...
public class StartActivity extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabHost.addTab(tabHost.newTabSpec("search")
                .setIndicator(getText(R.string.search_label), getResources().getDrawable(R.drawable.ic_tab_search))
        ...
        tabHost.addTab(tabHost.newTabSpec("favorites")
                .setIndicator(getText(R.string.favorites_label), getResources().getDrawable(R.drawable.ic_tab_favorites))

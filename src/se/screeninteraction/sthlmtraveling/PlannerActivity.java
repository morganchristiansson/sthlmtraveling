...
import se.screeninteraction.sthlmtraveling.FromToActivity.FromActivity;
import se.screeninteraction.sthlmtraveling.FromToActivity.ToActivity;
import se.screeninteraction.sthlmtraveling.provider.HistoryDbAdapter;
...
public class PlannerActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch(requestCode) {
        case ACTIVITY_FROM:
            mFromButton.setText(data.getCharSequenceExtra(RoutesActivity.EXTRA_START_POINT));
            break;
        case ACTIVITY_TO:
            mToButton.setText(data.getCharSequenceExtra(RoutesActivity.EXTRA_END_POINT));
            break;
        default:

...
import se.screeninteraction.sthlmtraveling.SectionedAdapter.Section;
...
import se.screeninteraction.sthlmtraveling.tasks.OnSearchRoutesResultListener;
import se.screeninteraction.sthlmtraveling.tasks.SearchEarlierRoutesTask;
import se.screeninteraction.sthlmtraveling.tasks.SearchLaterRoutesTask;
import se.screeninteraction.sthlmtraveling.tasks.SearchRoutesTask;
import se.screeninteraction.sthlmtraveling.util.Tracker;
import se.screeninteraction.sthlmtraveling.utils.BarcodeScannerIntegrator;
...
public class RoutesActivity extends ListActivity implements OnSearchRoutesResultListener {
    ...
    private void findRouteDetails(final Route route) {
        ...
        i.putExtra(RoutesActivity.EXTRA_START_POINT, mFromView.getText().toString());
        i.putExtra(RoutesActivity.EXTRA_END_POINT, mToView.getText().toString());
